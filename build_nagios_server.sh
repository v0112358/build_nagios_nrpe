...
### Build nagios + nrpe
yum install make gcc glibc glibc-common gd gd-devel net-snmp openssl-devel wget unzip -y
useradd nagios
groupadd nagcmd
...
cd /usr/local/src
wget -O nagios-4.3.4.tar.gz  https://assets.nagios.com/downloads/nagioscore/releases/nagios-4.3.4.tar.gz
